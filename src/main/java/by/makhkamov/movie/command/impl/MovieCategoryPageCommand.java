...
public class MovieCategoryPageCommand implements Command {
    ...
    private static final String PAGE_BY_CATEGORY_MOVIE = "/pages/main/admin/movies/page_by_category_movie.jsp";
    ...
    public Router execute(HttpServletRequest request) throws CommandException {
        ...
        try {
            ...
            session.setAttribute(CURRENT_PAGE, PAGE_BY_CATEGORY_MOVIE);
            return new Router(PAGE_BY_CATEGORY_MOVIE, Router.Type.FORWARD);
